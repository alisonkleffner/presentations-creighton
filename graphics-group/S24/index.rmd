...
.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/Attempt2.png", alt = "Alternative text description goes here.", other=list(width="35%"))
i2 <- img_modal(src = "images/Attempt2-scale.png", alt = "Alternative text description goes here.", other=list(width="30%"))
...
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/biv-plot-scale.png", alt = "Alternative text description goes here.",other=list(width="20%"))
...
.center[
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/corr-plot2.png", alt = "Alternative text description goes here.", other=list(width="40%"))
i2 <- img_modal(src = "images/corr-plot2b-scale.png", alt = "Alternative text description goes here.", other=list(width="30%"))
...
```{r results='asis', echo = F, include = T, cache = T, eval = TRUE}
i1 <- img_modal(src = "images/interactive-new.jpg", alt = "Alternative text description goes here.",other=list(width="50%"))
